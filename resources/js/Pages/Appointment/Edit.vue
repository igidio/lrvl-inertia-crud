...
const form = ref({
    id_cliente: props.cita.id_cliente,
    id_servicio: props.cita.id_servicio,
    fecha: null,
    hora: null,
...
const submit = () => {
    ...
    router.put(`/appointment/${props.cita.id}`, form.value);
}
...
const dateFormated = computed(() => {
    if (!(form.value.fecha instanceof Date))
        return 'Selecciona una nueva fecha y hora';
                        ...
                        <div class="card">
                                                ...
                                                <VDatePicker v-model="form.fecha" mode="dateTime" :rules="{
                                                    ...
                                                    <template #default="{ togglePopover }">
                                                        <div class="d-grid gap-2">
                                                            ...
                                                            <span class="mt-2">
                                                                {{ 'Fecha y hora previa: ' + cita.fecha + ' - ' +
                                                                    cita.hora
                                                                }}
                                                            </span>
                                                        </div>
                            ...
                            <div class="card-footer">
                                <div class="row justify-content-end m-2">
                                    ...
                                    <button class="btn btn-primary col-2" :disabled="!validate">Actualizar</button>
                                </div>
                            </div>
                        </div>
                    </form>
